...
echo "1. Frontend: scp -i your-key.pem frontend.zip ec2-user@54.147.45.32:~/"
echo "2. Backend: scp -i your-key.pem target/teashop-backend-0.0.1-SNAPSHOT.jar ec2-user@54.147.45.32:~/backend/teashop-backend.jar"
echo ""
echo "Then run:"
echo "  ./update-frontend.sh"
echo "  ./update-backend.sh"
echo ""
echo "Your site will be available at: http://54.147.45.32"